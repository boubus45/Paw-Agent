...
- Automatic validation command detection for common stacks (`pytest`, `npm test`, `cargo test`, `go test`, `dotnet test`, etc.), using the nearest changed subproject when possible.
